...
Las cookies serían útiles para datos pequeños que conviene recordar en el navegador, como idioma, tema visual, preferencias o mantener un recordatorio de inicio de sesión. Pero no son la mejor opción para guardar datos críticos del sistema, porque viven del lado del cliente y pueden ser manipuladas.
...
- created_at → timestamp: registra automáticamente la fecha y hora de creación del usuario, lo cual ayuda a llevar control del registro. EL id es clave primaria y nombre tiene restricción UNIQUE, para que no se repitan nombres de usuario. 
